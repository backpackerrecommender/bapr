...
namespace Bapr 
{
    public partial class MyEntityContext : BrightstarEntityContext {
        ...
        public static void InitializeEntityMappingStore()
        {
    		...
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(Bapr.Models.IInterest));
    		EntityMappingStore.Instance.SetImplMapping<Bapr.Models.IInterest, Bapr.Models.Interest>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(Bapr.Models.IUserPreference));
    		EntityMappingStore.Instance.SetImplMapping<Bapr.Models.IUserPreference, Bapr.Models.UserPreference>();
    	}
    	...
    	{
    		Interests = 	new BrightstarEntitySet<Bapr.Models.IInterest>(this);
    		UserPreferences = 	new BrightstarEntitySet<Bapr.Models.IUserPreference>(this);
    	}
    	
    	public IEntitySet<Bapr.Models.IInterest> Interests
    	{
    		get; private set;
    	}
    	
    	public IEntitySet<Bapr.Models.IUserPreference> UserPreferences
    	{
    		get; private set;
    	}
        ...
        public IEntitySet<T> EntitySet<T>() where T : class {
            ...
            if (typeof(T).Equals(typeof(Bapr.Models.IInterest))) {
                return (IEntitySet<T>)this.Interests;
            }
            if (typeof(T).Equals(typeof(Bapr.Models.IUserPreference))) {
...
namespace Bapr.Models 
{
    ...
    public partial class Interest : BrightstarEntityObject, IInterest 
    {
    	...
    	#region Implementation of Bapr.Models.IInterest
...
namespace Bapr.Models 
{
    ...
    public partial class UserPreference : BrightstarEntityObject, IUserPreference 
    {
    	...
    	#region Implementation of Bapr.Models.IUserPreference
    	...
    	public System.Collections.Generic.ICollection<Bapr.Models.IInterest> Interests
    	{
    		get { return GetRelatedObjects<Bapr.Models.IInterest>("Interests"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedObjects("Interests", value); }
    								}
    	public System.Collections.Generic.ICollection<Bapr.Models.IInterest> Cuisine
    	{
    		get { return GetRelatedObjects<Bapr.Models.IInterest>("Cuisine"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedObjects("Cuisine", value); }
    								}
    	public System.Collections.Generic.ICollection<System.String> SelectedInterests
    	{
    		get { return GetRelatedLiteralPropertiesCollection<System.String>("SelectedInterests"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedLiteralPropertiesCollection<System.String>("SelectedInterests", value); }
    	}
    	public System.Collections.Generic.ICollection<System.String> SelectedCuisine
    	{
    		get { return GetRelatedLiteralPropertiesCollection<System.String>("SelectedCuisine"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedLiteralPropertiesCollection<System.String>("SelectedCuisine", value); }
    	}
    	#endregion
    }
}
